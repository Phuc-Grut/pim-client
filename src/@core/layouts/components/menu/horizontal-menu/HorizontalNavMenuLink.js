...
const HorizontalNavMenuLink = ({ item, isChild, setMenuOpen }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/*{item.icon}*/}
        {/*<IconCustom typeIcon={item.typeIcon} iconName={item.icon} fontSize={17}/>*/}
        <IconCustom typeIcon={item.typeIcon} iconName={item.resAttributes && item.resAttributes.horizontalLayout ? item.resAttributes.horizontalLayout : ''} fontSize={17}/>
