...
const NavbarBookmarks = (props: any) => {
  ...
  //                       <IconTag className='me-50' fontSize={14} />
  //                       <span className='align-middle'>123{item.title}</span>
  //                     </DropdownItem>
  //                   )
  //                 })
  //                 .slice(10)}
  ...
  return (
    <Fragment>
      ...
      {/*          autoFocus={true}*/}
      {/*          defaultSuggestions*/}
      {/*          suggestionLimit={!value.length ? store.suggestions.length : 6}*/}
      {/*          placeholder='Search...'*/}
      ...
      {/*                    <IconTag fontSize={17.5} className='me-75' />*/}
