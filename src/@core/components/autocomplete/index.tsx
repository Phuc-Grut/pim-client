...
import { AlertCircle } from 'becoxy-icons'
...
const Autocomplete = (props: any) => {
  ...
  const inputElRef: any = useRef(null)
  const suggestionsListRef: any = useRef(null)
    ...
    if (sortSingleData.length) {
      ...
      return (
        <li className='suggestion-item no-result'>
          <AlertCircle fontSize={15} /> <span className='align-middle ms-50'>No Result</span>
        </li>
      )
    }
  }
