...
const SelectBox = (props: IFSelectBox) => {
  ...
  const { control, placeholder, disabled, name, options, label, isLabel, labelSize, classes, required, errors, isClearable, labelComponent, callback, inLine, handleGroupClick, iconGroup,  ...rest } = props
  const renderSelect = () => {
    return (
      <Fragment>
        <Controller
