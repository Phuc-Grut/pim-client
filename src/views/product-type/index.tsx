...
const ProductType = () => {
  ...
  const renderFields: IFieldView[] = [
    {
      value: dataItem.code, label: "Product type code"
    },
    {
      value: dataItem.name, label: "Product type name"
    },
    {
  ...
  return (
    <Fragment>
      ...
      {ability.can(userAction.OPEN, userSubject.Catalog) ? (
        <ProductTypeContext.Provider value={{ openModal, handleModal, dataItem, setDataItem, typeModal, setTypeModal, windowSize, openModalDetail, handleModalDetail }} >
