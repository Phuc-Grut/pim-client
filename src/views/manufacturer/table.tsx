...
import {canContextMenuItems} from "@src/views/manufacturer/contextMenu"
  ...
  return (
    <div className="d-flex justify-content-between align-items-center w-100">
      <div className="bar__action-left">
        <BreadCrumbsNotLink breadCrumbActive={t("Manufacturer")} />
      </div>
      <div className="bar__action-right d-flex">
        <CanPer I={userAction.ADD} a={userSubject.Manufacturer}>
...
const Table = () => {
  ...
  const handleModalSort = () => {
    getListManufacturerApi({$status: 1})
      .unwrap()
      .then((rs) => {
        setDataSort(rs)
  ...
  return (
    <Fragment>
      <div className="table-toolbar">
        ...
        <GridTableTemplate
          resource="tableManufacturers"
          idTable="Manufacturers"
          // rowHeight={40}
          dataTable={data}
