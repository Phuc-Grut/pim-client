...
const BankPage = () => {
  ...
  const renderFields: IFieldView[] = [
    {
      value: dataItem.code, label: "Manufacturer code"
    },
    {
      value: dataItem.name, label: "Manufacturer name"
    },
    {
  ...
  return (
    <Fragment>
      ...
      {ability.can(userAction.OPEN, userSubject.Manufacturer) ? (
        <ManufacturerContext.Provider value={{ openModal, handleModal, dataItem, setDataItem, typeModal, setTypeModal, windowSize, openModalDetail, handleModalDetail }} >
