...
const BankPage = () => {
  ...
  const renderFields: IFieldView[] = [
    {
      value: dataItem.code, label: "Product origin code"
    },
    {
      value: dataItem.name, label: "Product origin name"
    },
    {
  ...
  return (
    <Fragment>
      ...
      {ability.can(userAction.OPEN, userSubject.ProductOrigin) ? (
        <ProductOriginContext.Provider value={{ openModal, handleModal, dataItem, setDataItem, typeModal, setTypeModal, windowSize, openModalDetail, handleModalDetail }} >
