...
const ModalDetail = () => {
  ...
  return (
    ...
    >
      <ModalHeader handleModal={handleModalDetail} typeModal='View' title='Specification attribute' />
      <Scrollbars
        autoHide
        autoHeight
          ...
          <section>
            <div className='box form-box__border mb-3' style={{ padding: '15px' }}>
              ...
              <div className='row-detail'>
                <span className='row-detail__label'>{t('SpecificationAttributeCode')}:</span>

                <p className='row-detail__content'>{dataItem.code}</p>
              </div>
              <div className='row-detail'>
                <span className='row-detail__label'>{t('Specification attribute name')}:</span>
