...
import { IContext, SpecificationAttributeContext } from '../useContext'
...
const SideOption = () => {
  ...
  const { setDataTableDetail, dataSidebar, typeMo, dataTableDetail, setDataSidebar, windowSize, indexRow, setIndexRow, openSidebar, handleSidebar } = useContext<IContext>(SpecificationAttributeContext)
