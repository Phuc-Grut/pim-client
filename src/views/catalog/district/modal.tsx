...
import { IFDataDistrict } from "@src/domain/models/IDistrict"
...
const ModalComponent = () => {
  ...
  const { addDistrictApi, editDistrictApi } = useDistrict()
  ...
  const defaultValues: IFDataDistrict = {
    note: "",
    id: "",
    code: "",
    name: "",
  ...
  const handleFormOpened = () => {
    if (!isObjEmpty(dataItem)) {
      ...
      setValue("stateProvinceId", dataItem.stateProvinceId)
    } else {
      setValue("code", "")
      setValue("name", "")
      setValue("shortName", "")
  ...
  const dataToRender = () => {
    getListStateProvinceApi({ $status: 1 })
      .unwrap()
      .then((rs) => {
        setTimeout(() => {
                    ...
                    <div className="form-input-content">
                      <Controller
                        ...
                        render={({ field: { value, onChange } }) => (
                          <Select
                            value={optionStateProvince.find(
