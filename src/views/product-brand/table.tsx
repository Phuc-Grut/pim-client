...
import {canContextMenuItems} from "@src/views/product-brand/contextMenu"
  ...
  return (
    <div className="d-flex justify-content-between align-items-center w-100">
      <div className="bar__action-left">
        <BreadCrumbsNotLink breadCrumbActive={t("Product brand")} />
      </div>
      <div className="bar__action-right d-flex">
        <CanPer I={userAction.ADD} a={userSubject.ProductBrand}>
...
const Table = () => {
  ...
  const handleModalSort = () => {
    getListProductBrandApi({$status: 1})
      .unwrap()
      .then((rs) => {
        setDataSort(rs)
  ...
  return (
    <Fragment>
      <div className="table-toolbar">
        ...
        <GridTableTemplate
          resource="tableProductBrands"
          idTable="ProductBrands"
          // rowHeight={40}
          dataTable={data}
